 ...
 */
final class Version20220727153329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fridge (id VARCHAR(255) NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, is_default TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_F2E94D89A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item (id VARCHAR(255) NOT NULL, fridge_id VARCHAR(255) DEFAULT NULL, product_id INT DEFAULT NULL, expiration_date DATE DEFAULT NULL, INDEX IDX_1F1B251E14A48E59 (fridge_id), INDEX IDX_1F1B251E4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nutrition (id INT AUTO_INCREMENT NOT NULL, categories VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, ecoscore_grade VARCHAR(255) DEFAULT NULL, ecoscore_score VARCHAR(255) DEFAULT NULL, ingredients_text VARCHAR(255) DEFAULT NULL, nutriscore_grade VARCHAR(255) DEFAULT NULL, nutriscore_score VARCHAR(255) DEFAULT NULL, quantity VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, product_status_id INT DEFAULT NULL, ean VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, data LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', images_directory VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_name VARCHAR(255) DEFAULT NULL, image_original_name VARCHAR(255) DEFAULT NULL, image_mime_type VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, image_dimensions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', image_ingredients_name VARCHAR(255) DEFAULT NULL, image_ingredients_original_name VARCHAR(255) DEFAULT NULL, image_ingredients_mime_type VARCHAR(255) DEFAULT NULL, image_ingredients_size INT DEFAULT NULL, image_ingredients_dimensions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', image_nutrition_name VARCHAR(255) DEFAULT NULL, image_nutrition_original_name VARCHAR(255) DEFAULT NULL, image_nutrition_mime_type VARCHAR(255) DEFAULT NULL, image_nutrition_size INT DEFAULT NULL, image_nutrition_dimensions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', UNIQUE INDEX UNIQ_D34A04AD67B1C660 (ean), INDEX IDX_D34A04AD557B630 (product_status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expiration_date_notification DROP FOREIGN KEY FK_86EA6648A76ED395');
